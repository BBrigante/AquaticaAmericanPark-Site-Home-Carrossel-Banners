...
function NavigationArrows({ onPrevClick, onNextClick, isDesktop }) {
  const baseArrowClass = "absolute top-1/2 transform -translate-y-1/2 z-50 cursor-pointer bg-black/50 hover:bg-black/70 rounded-full p-2 transition-all duration-300";
  
  return (
    <>
      <button 
        className={`${baseArrowClass} left-4 ${isDesktop ? "w-12 h-12" : "w-10 h-10"}`} 
        onClick={onPrevClick}
      ...
      <button 
        className={`${baseArrowClass} right-4 ${isDesktop ? "w-12 h-12" : "w-10 h-10"}`} 
        onClick={onNextClick}
...
function Frame27Desktop() {
  return (
    <div className="bg-black box-border content-stretch flex items-center justify-center pb-[32px] pt-[24px] px-[48px] relative rounded-[20px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[3px] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_0px_30px_0px_#ff4200]" />
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[0px] text-nowrap text-white whitespace-pre">
        <p className="mb-0">
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[60px]">18</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[70px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[48px]">A</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[70px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[60px]">21</span>
        </p>
        <p className="text-[24px]">DE NOVEMBRO</p>
      </div>
    </div>
  );
}

function Frame26Desktop() {
  return (
    <div className="[grid-area:1_/_1] bg-black box-border content-stretch flex items-center justify-center ml-0 mt-0 pb-[48px] pl-[32px] pr-0 pt-[32px] relative rounded-[20px] w-[581px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[3px] border-solid inset-0 pointer-events-none rounded-[20px] shadow-[0px_0px_30px_0px_#ff4200]" />
      <p className="basis-0 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[24px] text-white">TENHA ACESSO ILIMITADO AO AQUÁTICA PAGANDO MENOS DE UM INGRESSO.</p>
    </div>
  );
}

function Frame26Desktop1() {
  return (
    <div className="[grid-area:1_/_1] bg-white box-border content-stretch flex items-center justify-center ml-[27px] mt-[130px] px-[24px] py-[8px] relative rounded-[100px]">
      <div aria-hidden="true" className="absolute border-2 border-[#ff4200] border-solid inset-0 pointer-events-none rounded-[100px] shadow-[0px_0px_30px_0px_#ff4200]" />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[20px] text-black text-nowrap whitespace-pre">+ BÔNUS ESPECIAL</p>
    </div>
  );
}

function Group26Desktop() {
  return (
...
function TextDesktop() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end right-[160px] top-[calc(50%+8px)] translate-y-[-50%] w-[581px] z-10" data-name="Text">
      <Frame27Desktop />
      <Group26Desktop />
    </div>
  );
...
function Banner1Desktop() {
  return (
    <a href="https://lp.aquaticaamericanpark.com.br/black-po/" className="block relative size-full cursor-pointer">
      <div className="h-[955px] relative shrink-0 w-full" data-name="Hero Image">
        <div className="absolute inset-0">
          <img alt="" className="absolute max-w-none object-50%-50% object-cover size-full" src={imgHeroImage1} />
          <img alt="" className="absolute max-w-none object-50%-50% object-cover size-full" src={imgHeroImage2} />
        </div>
      </div>
      <div className="absolute h-[547px] left-[100px] top-[164px] w-[562px] z-10" data-name="logo black 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgLogoBlack1} />
      </div>
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex items-center justify-center p-[12px] relative w-full">
          <p className="basis-0 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-bold font-normal grow leading-[1.5] min-h-px min-w-px relative shrink-0 text-[0px] text-[20px] text-center text-white">
            <span>{`1º LOTE LIBERADO COM `}</span>
            <span className="text-[#e3a530] font-bold">INGRESSOS LIMITADOS</span>
            <span>{`, APROVEITE!`}</span>
          </p>
        </div>
      </div>
...
function Banner2Desktop() {
  return (
    <a href="https://loja.aquaticaamericanpark.com.br/?ingToken=showanacastela&date=07%2F02%2F2026" className="block relative size-full cursor-pointer overflow-clip">
      <div className="h-[955px] relative shrink-0 w-full" data-name="Hero Image">
        <div className="absolute inset-0">
...
// THIRD BANNER COMPONENTS (REPLACING WITH NEW CODE)
// Banner3Desktop component
function Banner3BackgroundVectorsDesktop() {
  return (
    <div className="h-px relative w-[1920px]" data-name="Background Vectors">
...
function Banner3Frame30Desktop() {
  return (
...
function Banner3Desktop() {
  return (
    <a href="https://aquaticaamericanpark.com.br/anacastela" target="_blank" rel="noopener noreferrer" className="block relative size-full cursor-pointer overflow-clip">
      ...
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%] z-30">
          <Banner3BackgroundVectorsDesktop />
        </div>
      </div>
      <Banner3Frame30Desktop />
    </a>
  );
}
...
function Frame27Desktop1() {
  return (
    <div className="bg-black box-border content-stretch flex items-center justify-center pb-[20.48px] pt-[15.36px] px-[30.72px] relative rounded-[12.8px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.92px] border-solid inset-0 pointer-events-none rounded-[12.8px] shadow-[0px_0px_19.2px_0px_#ff4200]" />
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[0px] text-nowrap text-white whitespace-pre">
        <p className="mb-0">
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[38.4px]">18</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[44.8px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[30.72px]">A</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[44.8px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[38.4px]">21</span>
        </p>
        <p className="text-[15.36px]">DE NOVEMBRO</p>
      </div>
    </div>
  );
}

function Frame26Desktop2() {
  return (
    <div className="[grid-area:1_/_1] bg-black box-border content-stretch flex h-[112px] items-center justify-center ml-0 mt-0 pb-[38.4px] pl-[25.6px] pr-0 pt-[25.6px] relative rounded-[16px] w-[388.8px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[2.4px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_0px_24px_0px_#ff4200]" />
      <p className="basis-0 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold grow leading-[1.4] min-h-px min-w-px relative shrink-0 text-[18px] text-white">TENHA ACESSO ILIMITADO AO AQUÁTICA PAGANDO MENOS DE UM INGRESSO.</p>
    </div>
  );
}

function Frame26Desktop3() {
  return (
    <div className="[grid-area:1_/_1] bg-white box-border content-stretch flex items-center justify-center ml-[17.399px] mt-[89.2px] px-[19.2px] py-[6.4px] relative rounded-[80px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.6px] border-solid inset-0 pointer-events-none rounded-[80px] shadow-[0px_0px_24px_0px_#ff4200]" />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">+ BÔNUS ESPECIAL</p>
    </div>
  );
}

function Group26Desktop1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <Frame26Desktop2 />
      <Frame26Desktop3 />
...
function TextDesktop1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-end right-[100px] top-[calc(50%-0.58px)] translate-y-[-50%] z-10" data-name="Text">
      <Frame27Desktop1 />
      <Group26Desktop1 />
    </div>
  );
...
function Banner1Desktop1() {
  return (
    <a href="https://lp.aquaticaamericanpark.com.br/black-po/" className="block relative size-full cursor-pointer">
      ...
      <div className="absolute h-[384px] left-0 top-[190px] w-[395px] z-10" data-name="logo black 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgLogoBlack1} />
      </div>
      <TextDesktop1 />
    </a>
...
function Banner2Desktop1() {
  return (
    <a href="https://loja.aquaticaamericanpark.com.br/?ingToken=showanacastela&date=07%2F02%2F2026" className="block relative size-full cursor-pointer">
      <div className="h-[799px] relative shrink-0 w-full" data-name="Hero Image">
        <div className="absolute inset-0">
...
// Banner3Desktop1 component (replace with new code)
function Banner3BackgroundVectorsDesktop1() {
  return (
    <div className="h-px relative w-[1920px]" data-name="Background Vectors">
      <div className="absolute inset-[-1442.94%_-32.19%_-28784.8%_-30.81%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 304">
...
function Banner3Frame30Desktop1() {
  return (
...
function Banner3Desktop1() {
  return (
    <a href="https://aquaticaamericanpark.com.br/anacastela" target="_blank" rel="noopener noreferrer" className="block relative size-full cursor-pointer overflow-clip">
      ...
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%] z-30">
          <Banner3BackgroundVectorsDesktop1 />
        </div>
      </div>
      <Banner3Frame30Desktop1 />
    </a>
  );
}
...
function Frame27Tablet() {
  return (
    <div className="bg-black box-border content-stretch flex items-center justify-center pb-[19.2px] pt-[14.4px] px-[28.8px] relative rounded-[12px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.8px] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_0px_18px_0px_#ff4200]" />
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[0px] text-nowrap text-white whitespace-pre">
        <p className="mb-0">
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[36px]">18</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[42px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[28.8px]">A</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[42px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[36px]">21</span>
        </p>
        <p className="text-[14.4px]">DE NOVEMBRO</p>
      </div>
    </div>
  );
}

function Frame26Tablet() {
  return (
    <div className="[grid-area:1_/_1] bg-black box-border content-stretch flex items-center justify-center ml-0 mt-0 pb-[28.8px] pl-[19.2px] pr-0 pt-[19.2px] relative rounded-[12px] w-[348.6px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.8px] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_0px_18px_0px_#ff4200]" />
      <p className="basis-0 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[14.4px] text-white">TENHA ACESSO ILIMITADO AO AQUÁTICA PAGANDO MENOS DE UM INGRESSO.</p>
    </div>
  );
}

function Frame26Tablet1() {
  return (
    <div className="[grid-area:1_/_1] bg-white box-border content-stretch flex items-center justify-center ml-[101.2px] mt-[70px] px-[14.4px] py-[4.8px] relative rounded-[60px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.2px] border-solid inset-0 pointer-events-none rounded-[60px] shadow-[0px_0px_18px_0px_#ff4200]" />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">+ BÔNUS ESPECIAL</p>
    </div>
  );
}

function Group26Tablet() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <Frame26Tablet />
      <Frame26Tablet1 />
...
function TextTablet() {
  return (
    <div className="absolute bottom-[230px] content-stretch flex flex-col gap-[14.4px] items-center justify-center left-[calc(50%-0.001px)] translate-x-[-50%] w-[348.6px] z-10" data-name="Text">
      <Frame27Tablet />
      <Group26Tablet />
    </div>
  );
...
function Banner1Tablet() {
  return (
    <a href="https://lp.aquaticaamericanpark.com.br/black-po/" className="block relative size-full cursor-pointer">
      ...
      <TextTablet />
      <div className="absolute h-[434.7px] left-[calc(50%-0.691px)] top-[100px] translate-x-[-50%] w-[446.516px] z-10" data-name="logo black 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgLogoBlack1} />
      </div>
    </a>
  );
...
// Banner3Tablet component (replace with new code)
function Banner3BackgroundVectorsTablet() {
  return (
    <div className="h-px relative w-[1400px]" data-name="Background Vectors">
...
function Banner3Tablet() {
  return (
    <a href="https://aquaticaamericanpark.com.br/anacastela" target="_blank" rel="noopener noreferrer" className="block relative size-full cursor-pointer">
      ...
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%] z-30">
          <Banner3BackgroundVectorsTablet />
        </div>
      </div>
...
function Frame27Mobile() {
  return (
    <div className="bg-black box-border content-stretch flex items-center justify-center pb-[15.36px] pt-[11.52px] px-[23.04px] relative rounded-[9.6px] shrink-0">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.44px] border-solid inset-0 pointer-events-none rounded-[9.6px] shadow-[0px_0px_14.4px_0px_#ff4200]" />
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[0px] text-nowrap text-white whitespace-pre">
        <p className="mb-0">
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[28.8px]">18</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[33.6px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[23.04px]">A</span>
          <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] text-[33.6px]"> </span>
          <span className="font-['Plus_Jakarta_Sans:Bold_Italic',sans-serif] italic text-[#ff4200] text-[28.8px]">21</span>
        </p>
        <p className="text-[11.52px]">DE NOVEMBRO</p>
      </div>
    </div>
  );
}

function Frame26Mobile() {
  return (
    <div className="[grid-area:1_/_1] bg-black box-border content-stretch flex items-center justify-center ml-0 mt-0 pb-[23.04px] pl-[15.36px] pr-0 pt-[15.36px] relative rounded-[9.6px] w-[278.88px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[1.44px] border-solid inset-0 pointer-events-none rounded-[9.6px] shadow-[0px_0px_14.4px_0px_#ff4200]" />
      <p className="basis-0 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[11.52px] text-white">TENHA ACESSO ILIMITADO AO AQUÁTICA PAGANDO MENOS DE UM INGRESSO.</p>
    </div>
  );
}

function Frame26Mobile1() {
  return (
    <div className="[grid-area:1_/_1] bg-white box-border content-stretch flex items-center justify-center ml-[81.96px] mt-[57.4px] px-[11.52px] py-[3.84px] relative rounded-[48px]">
      <div aria-hidden="true" className="absolute border-[#ff4200] border-[0.96px] border-solid inset-0 pointer-events-none rounded-[48px] shadow-[0px_0px_14.4px_0px_#ff4200]" />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[9.6px] text-black text-nowrap whitespace-pre">+ BÔNUS ESPECIAL</p>
    </div>
  );
}

function Group26Mobile() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <Frame26Mobile />
      <Frame26Mobile1 />
...
function TextMobile() {
  return (
    <div className="absolute bottom-[150px] content-stretch flex flex-col gap-[11.52px] items-center justify-center left-[calc(50%+0.299px)] translate-x-[-50%] w-[278.88px] z-10" data-name="Text">
      <Frame27Mobile />
      <Group26Mobile />
    </div>
  );
...
function Banner1Mobile() {
  return (
    <a href="https://lp.aquaticaamericanpark.com.br/black-po/" className="block relative size-full cursor-pointer">
      ...
      <TextMobile />
      <div className="absolute h-[298.08px] left-[calc(50%+0.064px)] top-[90px] translate-x-[-50%] w-[306.182px] z-10" data-name="logo black 1">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover size-full" src={imgLogoBlack1} />
      </div>
    </a>
  );
...
// Banner3Mobile component (replace with new code)
function Banner3BackgroundVectorsMobile() {
  return (
    <div className="h-px relative w-[1308px]" data-name="Background Vectors">
...
function Banner3Mobile() {
  return (
    <a href="https://aquaticaamericanpark.com.br/anacastela" target="_blank" rel="noopener noreferrer" className="block relative size-full cursor-pointer">
      ...
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%] z-30">
          <Banner3BackgroundVectorsMobile />
        </div>
      </div>
...
function HeroSection({rotationDuration = 5, showArrows = true}) {
  ...
  // navigate cyclically between banners (0, 1, and 2)
  const totalBanners = 3; // Now we have 3 banners
  ...
  if (width < 700) {
    return (
      <div className="relative w-full h-[791px] min-h-[791px] overflow-hidden">
