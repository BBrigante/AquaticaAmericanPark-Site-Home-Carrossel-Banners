...
import svgUqPaths from "./svg-uq3hknwsnl"; // New SVG paths for the family vacation banner
...
// First banner assets - new vacation banner images
import imgVacationHeroImage from "figma:asset/d5fd8879f4dc9c0964d9e974d9f93e5b32ba8c7c.png"; // Old desktop background
import imgImage15 from "figma:asset/7b802c3c4d4cae3f5f26bdbc1fe4f47d01b25477.png"; // Logo
import imgVacationHeroImage1 from "figma:asset/03878097053cc12793febecbff92fdcfae680252.png"; // Tablet placeholder (unused now)
import imgBanner700X1100Px31 from "figma:asset/ae8ca507d5c5424ed618552fd37797077b27246d.png"; // Mobile first banner image
import imgBanner700X1100Px21 from "figma:asset/fb569aa39c9f318f29ba3340bdb120c7aab0e50c.png"; // Tablet first banner image
import imgBanner21 from "figma:asset/06b27d9e3050be7bf860a9a19c4800a97471679b.png"; // New desktop banner for 1920+ and 1200-1919
...
// NEW BANNER COMPONENTS (FAMILY VACATION)
function VacationBackgroundVectorsDesktop() {
  return (
    <div className="h-px relative w-[1920px]" data-name="Background Vectors">
      <div className="absolute inset-[-141.35%_-29.95%_-29782.9%_-33.05%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 301">
          <g id="Background Vectors">
            <path d={svgUqPaths.pbc970f0} data-figma-bg-blur-radius="10" fill="url(#paint0_linear_1345_91928)" id="Vector 4" />
            <path d={svgUqPaths.p3794900} data-figma-bg-blur-radius="10" fill="var(--fill-0, #0065BA)" id="Vector 3" />
          </g>
          <defs>
            <clipPath id="bgblur_0_1345_91928_clip_path" transform="translate(10 -2.60483)">
              <path d={svgUqPaths.pbc970f0} />
            </clipPath>
            <clipPath id="bgblur_1_1345_91928_clip_path" transform="translate(-50.2082 10)">
              <path d={svgUqPaths.p3794900} />
            </clipPath>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1345_91928" x1="65.6867" x2="593.958" y1="172.064" y2="-959.657">
...
function VacationHeroSectionDesktop() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[956px] items-start mb-[-1px] p-0 relative shrink-0 w-full" data-name="Hero Section" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="h-[955px] relative shrink-0 w-full" data-name="Hero Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBanner21} />
      </div>
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <VacationBackgroundVectorsDesktop />
        </div>
      </div>
    </a>
  );
...
function VacationFrame32Desktop() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center leading-[normal] relative shrink-0 text-nowrap w-[636px] whitespace-pre">
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[30px] text-white">Venha aproveitar as melhores</p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold relative shrink-0 text-[#f7a424] text-[55px]">FÉRIAS EM FAMÍLIA</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[30px] text-white">no Aquática American Park</p>
    </div>
  );
}

function VacationFrame14Desktop() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[75px] items-start justify-center p-0 relative shrink-0 w-[382px]" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="bg-[#0065ba] h-[81px] relative rounded-[24px] shrink-0 w-full" data-name="Button-M" role="link" tabIndex="0">
        <div aria-hidden="true" className="absolute border-[#f58410] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[24px]" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] h-[81px] items-center justify-center px-[24px] py-[28px] relative w-full">
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.6] relative shrink-0 text-[20px] text-nowrap text-white whitespace-pre">CLIQUE E GARANTA AGORA!</p>
          </div>
        </div>
      </div>
    </a>
...
function VacationFrame2147236484Desktop() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[25px] h-[450px] items-center right-[1064px] top-[233px] w-[628px]">
      <div className="h-[147px] relative shrink-0 w-[337px]" data-name="image 15">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage15} />
      </div>
      <VacationFrame32Desktop />
      <VacationFrame14Desktop />
    </div>
  );
}

function VacationGroup36Desktop() {
  return (
    <div className="absolute contents right-[1064px] top-[233px]">
      <VacationFrame2147236484Desktop />
    </div>
  );
}

function VacationBannerDesktop() {
  return (
    <section className="content-stretch flex flex-col items-start pb-px pt-0 px-0 relative size-full" data-name="Content Container">
      <VacationHeroSectionDesktop />
      <VacationGroup36Desktop />
    </section>
  );
}

function VacationBackgroundVectorsDesktop1() {
  return (
    <div className="h-px relative w-[1920px]" data-name="Background Vectors">
      <div className="absolute inset-[-1442.94%_-32.19%_-28784.8%_-30.81%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 304">
          <g id="Background Vectors">
            <path d={svgPaths.p3bbf2e00} data-figma-bg-blur-radius="10" fill="url(#paint0_linear_1317_39249)" id="Vector 4" />
...
function VacationHeroSectionDesktop1() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[800px] items-center mb-[-1px] p-0 relative shrink-0 w-full" data-name="Hero Section" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      ...
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <VacationBackgroundVectorsDesktop1 />
        </div>
      </div>
    </a>
  );
...
function VacationFrame32Desktop1() {
  return (
    <div className="content-stretch flex flex-col h-[127px] items-center justify-center leading-[normal] relative shrink-0 text-nowrap w-[579px] whitespace-pre">
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[22px] text-white">Venha aproveitar as melhores</p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold relative shrink-0 text-[#f7a424] text-[45px]">FÉRIAS EM FAMÍLIA</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[22px] text-white">no Aquática American Park</p>
    </div>
  );
}

function VacationFrame14Desktop1() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[42px] items-start justify-center p-0 relative shrink-0 w-[324px]" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="bg-[#0065ba] content-stretch flex gap-[4px] h-[60px] items-center justify-center px-[24px] py-[28px] relative rounded-[20px] shrink-0 w-[325px]" data-name="Button-M" role="link" tabIndex="0">
        <div aria-hidden="true" className="absolute border-[#f58410] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[20px]" />
        <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.6] relative shrink-0 text-[18px] text-nowrap text-white whitespace-pre">CLIQUE E GARANTA AGORA!</p>
      </div>
    </a>
  );
}

function VacationFrame2147236484Desktop1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[18px] h-[467px] items-center left-[125px] top-[215px] w-[510px]">
      <div className="h-[126px] relative shrink-0 w-[288px]" data-name="image 15">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage15} />
      </div>
      <VacationFrame32Desktop1 />
      <VacationFrame14Desktop1 />
    </div>
  );
}

function VacationGroup36Desktop1() {
  return (
    <div className="absolute contents left-[228px] top-[215px]">
      <VacationFrame2147236484Desktop1 />
    </div>
  );
}

function VacationBannerDesktop1() {
  return (
    <section className="content-stretch flex flex-col items-start pb-px pt-0 px-0 relative size-full" data-name="Content Container">
      <VacationHeroSectionDesktop1 />
      <VacationGroup36Desktop1 />
    </section>
  );
}

function VacationBackgroundVectorsTablet() {
  return (
    <div className="h-px relative w-[1400px]" data-name="Background Vectors">
      <div className="absolute inset-[-1442.94%_-81.29%_-28784.8%_-42.25%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 304">
          <g id="Background Vectors">
            <path d={svgPaths.p3bbf2e00} data-figma-bg-blur-radius="10" fill="url(#paint0_linear_1317_39245)" id="Vector 4" />
...
function VacationHeroSectionTablet() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[1100px] items-center mb-[-1px] p-0 relative shrink-0 w-full" data-name="Hero Section" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="h-[1099px] relative shrink-0 w-full" data-name="Hero Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBanner700X1100Px21} />
      </div>
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <VacationBackgroundVectorsTablet />
        </div>
      </div>
    </a>
  );
...
function VacationFrame32Tablet() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center leading-[normal] relative shrink-0 text-nowrap w-[636px] whitespace-pre">
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[18px] text-white">Venha aproveitar as melhores</p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold relative shrink-0 text-[#f7a424] text-[35px]">FÉRIAS EM FAMÍLIA</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[18px] text-white">no Aquática American Park</p>
    </div>
  );
}

function VacationFrame14Tablet() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[41px] items-start justify-center p-0 relative shrink-0 w-[238px]" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="bg-[#0065ba] h-[50px] relative rounded-[16px] shrink-0 w-[240px]" data-name="Button-M" role="link" tabIndex="0">
        <div aria-hidden="true" className="absolute border-[#f58410] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] h-[50px] items-center justify-center px-[24px] py-[28px] relative w-[240px]">
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.3] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">CLIQUE E GARANTA AGORA!</p>
          </div>
        </div>
      </div>
    </a>
...
function VacationFrame2147236484Tablet() {
  return (
    <div className="flex flex-col gap-[14px] h-auto items-center w-auto">
      <div className="h-[81px] relative shrink-0 w-[185px]" data-name="image 15">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage15} />
      </div>
      <VacationFrame32Tablet />
      <VacationFrame14Tablet />
    </div>
  );
}

function VacationGroup36Tablet() {
  return (
    <div className="absolute inset-x-0 bottom-[150px] flex items-center justify-center">
      <VacationFrame2147236484Tablet />
    </div>
  );
}

function VacationBannerTablet() {
  return (
    <div className="content-stretch flex flex-col items-start pb-px pt-0 px-0 relative size-full" data-name="Content Container">
      <VacationHeroSectionTablet />
      <VacationGroup36Tablet />
    </div>
  );
}

function VacationBackgroundVectorsMobile() {
  return (
    <div className="h-px relative w-[1308px]" data-name="Background Vectors">
      <div className="absolute inset-[-1442.94%_-94.04%_-28784.8%_-45.23%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 304">
          <g id="Background Vectors">
            <path d={svgPaths.p3bbf2e00} data-figma-bg-blur-radius="10" fill="url(#paint0_linear_1317_39239)" id="Vector 4" />
            <path d={svgPaths.p11ef700} data-figma-bg-blur-radius="10" fill="var(--fill-0, #0065BA)" id="Vector 3" />
          </g>
          <defs>
...
function VacationHeroSectionMobile() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[791px] items-center mb-[-1px] p-0 relative shrink-0 w-full" data-name="Hero Section" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="h-[790px] relative shrink-0 w-full" data-name="Hero Image">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBanner700X1100Px31} />
      </div>
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <VacationBackgroundVectorsMobile />
        </div>
      </div>
    </a>
  );
...
function VacationFrame32Mobile() {
  return (
    <div className="flex flex-col items-center justify-center leading-[normal] relative shrink-0 text-nowrap w-auto whitespace-pre">
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[14px] text-white">Venha aproveitar as melhores</p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold relative shrink-0 text-[#f7a424] text-[26px]">FÉRIAS EM FAMÍLIA</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal not-italic relative shrink-0 text-[14px] text-white">no Aquática American Park</p>
    </div>
  );
}

function VacationFrame14Mobile() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col h-[27px] items-center justify-center p-0 relative shrink-0 w-[170px]" href="https://loja.aquaticaamericanpark.com.br/" target="_blank" rel="noopener noreferrer">
      <div className="bg-[#0065ba] h-[34px] relative rounded-[12px] shrink-0 w-[172px]" data-name="Button-M" role="link" tabIndex="0">
        <div aria-hidden="true" className="absolute border-[#f58410] border-[1.5px] border-solid inset-0 pointer-events-none rounded-[12px]" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex gap-[4px] h-[34px] items-center justify-center px-[24px] py-[28px] relative w-[172px]">
            <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2] relative shrink-0 text-[10px] text-nowrap text-white whitespace-pre">CLIQUE E GARANTA AGORA!</p>
          </div>
        </div>
      </div>
    </a>
...
function VacationFrame2147236484Mobile() {
  return (
    <div className="flex flex-col gap-[8px] h-auto items-center w-auto">
      <div className="h-[54px] relative shrink-0 w-[122px]" data-name="image 15">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage15} />
      </div>
      <VacationFrame32Mobile />
      <VacationFrame14Mobile />
    </div>
  );
}

function VacationGroup36Mobile() {
  return (
    <div className="absolute inset-x-0 bottom-[160px] flex items-center justify-center">
      <VacationFrame2147236484Mobile />
    </div>
  );
}

function VacationBannerMobile() {
  return (
    <div className="content-stretch flex flex-col items-start pb-px pt-0 px-0 relative size-full" data-name="Content Container">
      <VacationHeroSectionMobile />
      <VacationGroup36Mobile />
    </div>
  );
}
      ...
      <div className="absolute inset-[-1442.94%_-94.04%_-28784.8%_-45.23%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3130 304">
          ...
          <defs>
            ...
            <clipPath id="bg`blur_1_1059_69316_clip_path" transform="translate(-38.5136 10)">
              <path d={svgPaths.p11ef700} />
            </clipPath>
